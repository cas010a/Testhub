...
export default {
  ...
  interface: {
    ...
    extractRules: 'Extract Variables',
    addExtractRule: 'Add Rule',
    extractHint: 'After the request succeeds, values are extracted from the response and written into the environment variables; other requests can reference them like {{token}}',
    extractRuleName: 'Variable name, e.g. token',
    extractRuleExpression: 'JSONPath e.g. $.data.token (for header source, enter header name)',
    extractSourceBody: 'Body',
    extractSourceHeader: 'Header',
    noExtractRules: 'No extract rules. Add rules to auto-update environment variables when this request runs',
    extractedVars: 'Extracted variables (auto-saved to environment)',
    extractedVarsTip: 'Reference in other requests via {name}',

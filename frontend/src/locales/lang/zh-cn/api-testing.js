...
export default {
  ...
  interface: {
    ...
    extractHint: '接口执行成功后，自动从响应中提取值并写入环境变量，其他接口可用 {{token}} 类似形式引用',
    extractRuleName: '变量名，如 token',
    extractRuleExpression: 'JSONPath 如 $.data.token（响应头填 Header 名称）',
    extractSourceBody: '响应体',
    extractSourceHeader: '响应头',
    noExtractRules: '未配置提取规则。添加规则后，执行该接口即可自动更新环境变量',
    extractedVars: '已提取变量（已自动写入环境变量）',
    extractedVarsTip: '其他接口可用 {name} 引用',
    noAssertions: '暂无断言配置',
